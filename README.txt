...
Följande egenskaper skall användas för att ge stil till något (variantformer är ok): background, border, color,
font, margin, overflow, padding, position och text-transform.
...
Inlämningen skall ske via Classroom och måste ske i tid. Behöver du komplettera din inlämning kan du endast
få G.
